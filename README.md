...
node src/cli.mjs sop run --root ./docs/eval/eval2/sop --prefix eval2 --package eval2.analysis
```
...
See [the HTML documentation](docs/index.html), [the manual CLI tutorial](docs/tutorial.html), [the evaluation
