...
7. Use `$author-sop-circuit`; compile the candidate and run positive, negative, boundary, exception, malformed-input, and refusal cases. For entailment candidates, include direct, multi-step derived, unknown, cyclic, conflicting, and unsupported-rule examples. Record exact commands and outcomes.
