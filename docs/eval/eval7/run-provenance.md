...
| --- | --- | --- | --- | --- |
| `task2` | `14:04:16–14:08:40` | 0 | `SUCCEEDED` | `sha256:60ad88c3…1701` |
| `task3` | `14:09:57–14:13:07` | 0 | `SUCCEEDED` | `sha256:6ae252e7…c9e` |

Commands used `-kbdir ./docs/eval/eval7/kb -workdir ./docs/eval/eval7/taskN -agent codex`. Each executor report contains
the generated SOP document and independent verification.
